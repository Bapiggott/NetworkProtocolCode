...
json_file = 'output_predictions_test_udp_small_distilgpt2_1.json' # output_predictions_test_udp_small_distilgpt2.json'
...
if  json_file.endswith(".json"): # input_file_path.startswith("7b_output_predictions_") and
