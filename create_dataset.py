...
def process_dict_udp(data_dict, prefix='', result=None):
    ...
    for key, value in data_dict.items():
        ...
        if isinstance(value, dict):
            ...
            if key_string not in ["payload", "port"]:
                result[key_string] = value
...
def create_sliding_window_2(file, output_file_path, window_size):
    ...
    with open(file, 'rb') as data:
        with open(f'6{output_file_path}', 'a+') as output_file:
                ...
                try:
                    ...
                    if len(window) == window_size:
                        ...
                        if not first_item:
                            ...
                            output_file.write(",")"""
                            """with open(f'2{output_file_path}', 'r+') as file:
                                ...
                                # Write a comma at the current position
                                file.write(',')"""
                            output_file.write(',')
                        else:
                            output_file.write('[\n')
...
if __name__ == "__main__":
    ...
    filtered_jsons(jsons_output_directory, output_directory_filtered[0], 4)
